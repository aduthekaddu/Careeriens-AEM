...
public class PdProgramStudyPlanModel {
    ...
    public String getTabLabel()                 { return tabLabel != null ? tabLabel : "Study Plan"; }
    public String getTitle()                    { return title; }
    public List<TimelineItem> getItemList()     { return itemList; }
    public boolean isHasItems()                 { return !itemList.isEmpty(); }
    ...
    public static class TimelineItem {
        ...
        public boolean isHasWeekLabel()   { return weekLabel != null && !weekLabel.isEmpty(); }
        public boolean isHasDesc()        { return itemDesc  != null && !itemDesc.isEmpty(); }
    }
}